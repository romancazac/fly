...
if (isMobile.any()) {
	...
	document.querySelector('.team__row').classList.add('_swiper');
	document.querySelector('.team__row').classList.add('team__slider');
}
...
let studyCenterSlide = new Swiper('.study-center__slide', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
